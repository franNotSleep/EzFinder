...
async function bootstrap() {
  ...
  /*
    ...
    and not lose context on POST requests
  */
  app.use(json());
  ...
  const config = new DocumentBuilder()
    .setTitle('Node API')
    .setDescription(
      `<a target="_blank" href="https://github.com/rodion-arr/nestjs-starter-kit">https://github.com/rodion-arr/nestjs-starter-kit</a>`,
    )
    .addBearerAuth()
    .build();
